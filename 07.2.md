...
![](/images/7.2_fig7.2.png)

示例 7.7 [array\_slices.go](examples/chapter_7/array_slices.go)
...
下图描述了使用 make 方法生成的切片的内存结构：![](/images/7.2_fig7.2.1.png)

示例 7.8 [make\_slice.go](examples/chapter_7/make_slice.go)
...
练习 7.4： fobinacci\_funcarray.go: 为练习 7.3 写一个新的版本，主函数调用一个使用序列个数作为参数的函数，该函数返回一个大小为序列个数的 Fibonacci 切片。
